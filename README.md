...
# CC Switch Kimi-Code
中文 | [English](README_EN.md)  | [日本語](README_JA.md) | [Deutsch](README_DE.md) | [Changelog](CHANGELOG.md)
...
Kimi Code 很强大，但供应商配置、工具、指令和会话记录分散在不同的文件与目录中。CC Switch Kimi Code 将日常工作集中到一个原生桌面界面里：
...
你不需要改变原有的 Kimi Code 使用方式。CC Switch Kimi Code  直接管理 Kimi Code 已经使用的文件，让 Kimi Code 继续负责实际运行。

## CC Switch Kimi Code  能管理什么
